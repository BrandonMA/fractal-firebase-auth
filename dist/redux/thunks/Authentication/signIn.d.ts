...
export declare const signIn: (slice: typeof authenticationSlice, user: EmailPasswordPair) => (dispatch: ThunkDispatch<firebase.Unsubscribe, MinimalExpectedReduxState, Action>) => Promise<void>;
