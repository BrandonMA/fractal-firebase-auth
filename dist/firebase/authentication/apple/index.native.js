...
export function apple() {
    return __awaiter(this, void 0, void 0, function () {
        var appleAuthRequestResponse, identityToken, nonce, appleCredential, userCredential;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, appleAuth.performRequest({
                        requestedOperation: appleAuth.Operation.LOGIN,
                        requestedScopes: [appleAuth.Scope.EMAIL, appleAuth.Scope.FULL_NAME]
                    })];
                case 1:
                    appleAuthRequestResponse = _a.sent();
                    ...
                    return [4 /*yield*/, auth().signInWithCredential(appleCredential)];
                case 2:
